...
<html lang="en">
  <head>
  	<title>Shareholder Insert</title>
  	<style>
  	input:focus + .help,
	input:invalid + .help {
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./shareholderinsert.php">ShareHolder Insert</a></li>
        <li ><a href="./shareholderdisplay.php">ShareHolder Display</a></li>
              </ul>
...
$sql = "SELECT ShareID FROM Shares";
...
while($i<$k)
{
	...
	if($i==3)
	{
		$p .='<div class="form-group">
      			<label for="select" class="col-lg-2 control-label">ShareId</label>
      			<div class="col-lg-10">
		...
		//		echo "Yes";
			...
			elseif($brr[$i][0] == 'i')
			{
				...
				$p .=	'<div class="form-group">
  					<label class="control-label" for="inputDefault">'.$arr[$i].'</label>
  					<input type ="number" min="1980" max="2014" class="form-control" id="inputDefault" placeholder='.$arr[$i].' name='.$i.' required aria-required=”true”  >
				    </div>';
				}
				else
				{
...
$i=$i+1;
	...
	echo '
		<form class="form-horizontal" action = "shareholderinsert.php" method="post">
  		<fieldset>
