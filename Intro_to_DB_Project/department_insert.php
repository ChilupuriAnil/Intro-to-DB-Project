  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./department_insert.php">Departments Insert</a></li>
        <li ><a href="./department_display.php">Departments Display</a></li>
              </ul>
...
$i=$i+1;
	...
	echo '
		<form class="form-horizontal" action = "department_insert.php" method="post">
  		<fieldset>
