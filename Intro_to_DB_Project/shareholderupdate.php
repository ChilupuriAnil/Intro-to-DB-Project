...
$val = $_POST['id'];
   if(isset($_POST['Update'])) {
        ...
        header('location: shareholderdisplay.php');
} 
function fun($p)
{
	global $conn;
    ...
    elseif($brr[$i][0] == 'v'  or $brr[$i][0] =='t')
        ...
        //      echo "Yes";
            ...
            elseif($brr[$i][0] == 'i')
            {
                ...
                $p .=   '<div class="form-group">
                    <label class="control-label" for="inputDefault">'.$arr[$i].'</label>
                    <input type ="number" min="1980" max="2014" class="form-control" id="inputDefault" placeholder='.$arr[$i].' name='.$i.' value = '.$field[$r][$arr[$i]] .' required aria-required="true" >
                    </div>';
                }
                else
                {
...
$i=$i+1;
	...
	echo '<div class="container">
		<form class="form-horizontal" action = "shareholderupdate.php" method="post">
  		<fieldset>
