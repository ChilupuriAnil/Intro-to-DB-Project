  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./employee_insert.php">Employee Insert</a></li>
        <li ><a href="./employee_display.php">Employee Display</a></li>
              </ul>
...
$i=$i+1;
	...
	echo '
		<form class="form-horizontal" action = "employee_insert.php" method="post">
  		<fieldset>
