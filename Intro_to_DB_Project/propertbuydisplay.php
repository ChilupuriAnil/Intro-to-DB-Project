  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./propertbuydisplay.php">Property TO BUY Display</a></li>
              </ul>
...
if (mysqli_num_rows($result) > 0)
{
	...
	$j=0;
 	while($i<$c)
 	{
 		...
 		$p .='<td>
        <form class="form-horizontal" action = "./propertbuydisplay.php" method="post">
        <fieldset>
        ...
        $p .='<td>
        <form class="form-horizontal" action = "./propertybuyupdate.php" method="post">
        <fieldset>
        <div class="col-lg-10 col-lg-offset-2">
                <button type="submit" name="acc" class="btn btn-primary">Accept</button>
                <input type="hidden" name = "id" value='.$field[$i]["S_No"]. '>
                </div></fieldset>
        </form></td>';
        $p .='<td>
        ...
        <fieldset>
        <div class="col-lg-10 col-lg-offset-2">
                <button type="submit" name="rej" class="btn btn-primary">Reject</button>
                <input type="hidden" name = "id" value='.$field[$i]["S_No"]. '>
                </div></fieldset>
        </form></td>';
                $p .="</tr><tr>";
