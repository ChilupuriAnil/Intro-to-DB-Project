  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./contractinsert.php">Contract Insert</a></li>
        <li ><a href="./contractdisplay.php">Contract Display</a></li>
              </ul>
...
$i=$i+1;
	...
	echo '
		<form class="form-horizontal" action = "contractinsert.php" method="post">
  		<fieldset>
