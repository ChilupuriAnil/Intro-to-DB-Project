  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./worksforinsert.php">Works For Insert</a></li>
        <li ><a href="./worksfordisplay.php">Works For Display</a></li>
              </ul>
...
$i=$i+1;
	...
	echo '
		<form class="form-horizontal" action = "worksforinsert.php" method="post">
  		<fieldset>
