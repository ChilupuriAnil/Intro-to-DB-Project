...
?>
    ...
    <title>Your Requests For Selling</title>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       <li ><a href="./searchflat.php">Search For Flat</a></li>
        ...
        <li class="active"><a href="./clientpropertyselldisplay.php">Your Requests for Selling </a></li>
              </ul>
...
if (mysqli_num_rows($result) > 0)
{
 	...
 	while($i<$c)
 	{
       ...
       // echo $field[$i]['UserId'];
        if($mmm == $field[$i]['Seller'])
        {
 		...
 		$p .='<td>
 		<form class="form-horizontal" action = "clientpropertyselldisplay.php" method="post">
  		<fieldset>
    ...
    echo ' <legend> Your Requests of selling properties to Comapany are Displayed Here </legend> <table class="table table-striped table-hover"> <thead><tr>'; 
    echo $q;
