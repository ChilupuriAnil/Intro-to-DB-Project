  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="./shareholderinsert.php">ShareHolder Insert</a></li>
        <li class="active"><a href="./shareholderdisplay.php">ShareHolder Display</a></li>
              </ul>
...
if (mysqli_num_rows($result) > 0)
{
	...
	$j=1;
 	while($i<$c)
 	{
 		...
 		$p .='<td>
 		<form class="form-horizontal" action = "shareholderdisplay.php" method="post">
  		<fieldset>
