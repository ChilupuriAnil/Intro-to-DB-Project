  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="./soldinsert.php">Property Sold Insert</a></li>
        <li ><a href="./solddisplay.php">Property Sold Display</a></li>
              </ul>
...
if(isset($_POST['ins'])) {
		...
		$kkk=$_POST['1'];
		$xc ='SELECT  Price  FROM Property WHERE PropertyID ="';
		$xc .= $kkk;
		$xc .= '"';
$result11 = mysqli_query($conn,$xc);
...
while($i<$k)
{
	if($i==1)
	{
		$p .='<div class="form-group">
      			<label for="select" class="col-lg-2 control-label">PropertyId</label>
      			<div class="col-lg-10">
	...
	{
		$p .='<div class="form-group">
      			<label for="select" class="col-lg-2 control-label">Buyer</label>
      			<div class="col-lg-10">
        		<select class="form-control" id="select" name = ';
        		$p .= $i;
        		$p .= '>';
		...
		//		echo "Yes";
			...
			elseif($brr[$i][0] == 'y')
			{
				$p .=	'<div class="form-group">
  					<label class="control-label" for="inputDefault">'.$arr[$i].'</label>
  					<input type ="year" min="1" class="form-control" id="inputDefault" placeholder='.$arr[$i].' name='.$i.' required aria-required=”true”  >
				    </div>';
			}
			elseif($brr[$i][0] == 'i' and $i != 4 )
			{
				$p .=	'<div class="form-group">
  					<label class="control-label" for="inputDefault">'.$arr[$i].'</label>
...
$i=$i+1;
	...
	echo '
		<form class="form-horizontal" action = "soldinsert.php" method="post">
  		<fieldset>
    	<legend>Property Sold to Details insert</legend>';
				echo $p;
