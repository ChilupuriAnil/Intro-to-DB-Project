  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="./sharesinsert.php">Shares Insert</a></li>
        <li class="active"><a href="./sharesdisplay.php">Shares Display</a></li>
              </ul>
...
if (mysqli_num_rows($result) > 0)
{
	...
	$j=0;
 	while($i<$c)
 	{
 		...
 		$p .='<td>
 		<form class="form-horizontal" action = "./sharesdisplay.php" method="post">
  		<fieldset>
        ...
        $p .='<td>
        <form class="form-horizontal" action = "./sharesupdate.php" method="post">
        <fieldset>
        <div class="col-lg-10 col-lg-offset-2">
    ...
    echo '<table class="table table-striped table-hover"> <thread><tr>'; 
    echo $q;
